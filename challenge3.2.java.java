...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        students.add(new Student("Tom", "A123", 3.8));
        students.add(new Student("Jerry", "B456", 3.5));
        students.add(new Student("Sherlock", "C789", 3.9));
        students.add(new Student("clark", "D101", 3.2));
        students.add(new Student("Bruce wayne", "E202", 4.0));
